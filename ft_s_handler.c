...
static void	key_move(t_game *game, t_move move)
{
	...
	game->map[move.move_width][move.move_height] = game->map[move.move_width + 1][move.move_height];
	game->map[move.move_width + 1][move.move_height] = tmp;
	game->move_cnt++;
}
...
{
	game->map[move.move_width + 1][move.move_height] = game->map[move.move_width][move.move_height];
